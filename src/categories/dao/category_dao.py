...
class CategoryDao:
    def __init__(self):
        ...
        self.category_collection = self.__database.categories_collection()
    ...
    def create_category(self, category_model_instance: CategoryModel) -> InsertOneResult:
        ...
        """
        category_data_dict = category_model_instance.model_dump(by_alias=True)
