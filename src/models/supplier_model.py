...
class SupplierModel(BaseModel):
    id: Optional[int] = Field(default=None, description='ID of the supplier')
    name: Optional[str] = Field(default=None, min_length=3, max_length=50, description='Name of the supplier')
